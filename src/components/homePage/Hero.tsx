...
export default function Hero() {
  return (
    <section className="grid lg:h-[min(720px,calc(100svh-74px))] lg:grid-cols-[1fr_1.05fr]">
      <div className="order-2 flex flex-col justify-center overflow-y-auto bg-sand py-12 pr-5 pl-[max(20px,calc((100vw-1480px)/2+20px))] lg:order-1 lg:py-10 lg:pr-14 lg:pl-[max(40px,calc((100vw-1480px)/2+40px))] xl:pr-20">
